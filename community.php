                ...
                <?php foreach ($communities as $community): ?>
                    <div class="community-card">
                        ...
                        <div class="community-card-image-container">
                            ...
                            <div class="join">
                                <a href="communitycomm.php?community_id=<?php echo $community['Community_ID']; ?>&community_name=<?php echo urlencode($community['name']); ?>" style="text-decoration: none;">Join Community →</a>
                            </div>
                        </div>
                        <div class="info">
