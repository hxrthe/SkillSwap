...
// Fetch all admins
$all_communities = $conn->query("SELECT Community_ID, Community_Name FROM communities")->fetchAll(PDO::FETCH_ASSOC);
?>
    ...
    <div class="main-content">
        <div class="card">
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($all_communities as $communities): ?>
                    <tr>
                            <td><?php echo htmlspecialchars($communities['Community_ID']); ?></td>
                            <td><?php echo htmlspecialchars($communities['Community_Name']); ?></td>
                        <td>
